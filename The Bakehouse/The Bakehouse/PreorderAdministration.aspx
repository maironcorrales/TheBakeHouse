<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PreorderAdministration.aspx.cs" Inherits="The_Bakehouse.PreorderAdministration" %>
...
<head runat="server">
    <title>Admininstración de Productos en Preorden</title>
    <meta charset="utf-8"/>
                                    ...
                                    <div style="height: 300px;">
                                        <asp:Repeater runat="server" ID="popup_Notifications" OnItemDataBound="popup_Notifications_ItemDataBound">
                                            <ItemTemplate>
                                                <div id="noti_Item">
                                                    <a>
                                                        <asp:Label runat="server" ID="lbl_Notification_Popup"></asp:Label></a>
                                                    <hr />
                                                </div>
                                            </ItemTemplate>
                                        </asp:Repeater>
        ...
        .seeAll {
            ...
            .seeAll a {
                ...
                <section class="parallax parallax1" data-parallax-speed="-0.4">     
                    <h2>Introducir Producto en Pre orden</h2>     
            ...
            <div class="container">
                    ...
                    <div class="grid_5">
                        ...
                        <div id="contact-form" class='contact-form'>
                            ...
                            <fieldset>
                                ...
                                <label class="name">
                                    Precio:
                                    <input type="text" id="priceProduct" runat="server" name="name" 
                                           data-constraints="@Required"/>                
                                    <span class="empty-message">*Este campo es requerido.</span>
                                </label>
                                ...
                                <label class="name">
                                    Fecha Creacion:
                                    <input type="text" id="creationDateProduct" runat="server" name="name" 
                                           data-constraints="@Required"/>                
                                    <span class="empty-message">*Este campo es requerido.</span>
                                </label>
                                ...
                                <label class="name">
                                    Fecha Finalizacion:
                                    <input type="text" id="finishDateProduct" runat="server" name="name" 
                                           data-constraints="@Required"/>                
                                    <span class="empty-message">*Este campo es requerido.</span>
                                </label>                
                                ...
                                <div class="btn-wr">
                                    ...
                                    <a class="" runat="server" id="SavePreOrderProduct" onserverclick="SavePreOrderProduct_ServerClick">Guardar</a>
                ...
                <section class="well well__offset-3">
            <div class="container">
                <h2>Productos para Pre Ordenar</h2>
                <div class="row box-2">
                                ...
                                <div id="contact-form" class='contact-form' >
                                 <div class="btn-wr">
                                    <asp:LinkButton Visible="true" ID="EditBtn" runat="server" CommandName="EditProduct" Text="Editar"></asp:LinkButton>
                                     ...
                                     <asp:Button runat ="server" ID="updateProcess" OnClick="updateProcess_Click" Style="visibility:hidden;"  />
                         ...
                         <div class="btn-wr">
                            ...
                            <fieldset>
                                ...
                                <label class="Subject">
                                    ...
                                    <input style="width:75%;" type="date" id="updateDateCreation"  runat="server" />
                                    <span class="empty-message">*Este campo es requerido.</span>
                                ...
                                <label class="Subject">
                                    ...
                                    <input style="width:75%;" type="date" id="updateDateEnd"  runat="server" />
                                    <span class="empty-message">*Este campo es requerido.</span>
